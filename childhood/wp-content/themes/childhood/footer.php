<div class="question">
                    ...
                    <div class="col-md-8 offset-md-0 col-lg-6 col-xl-5 offset-xl-1">
                        <div class="footer__contacts">
                            <div class="footer__contacts-item">
                                ...
                                <a href="tel:<?php the_field('phone1', 42); ?>"><?php the_field('phone1', 42); ?></a>
                                <a href="tel:<?php the_field('phone2', 42); ?>"><?php the_field('phone2', 42); ?></a>
                                </div>
                            </div>
                            <div class="footer__contacts-item">
                                <img src="<?php echo bloginfo('template_url'); ?>/assets/img/icons/svg/pointer.svg" alt="указатель" class="footer__contacts-logo">
                                <address><?php the_field('address', 42); ?></address>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <?php
          wp_footer();
        ?>
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCDLZ3zF7m5Nn4lVDITnzNbMMsQVLeWvX4">
        </script>
