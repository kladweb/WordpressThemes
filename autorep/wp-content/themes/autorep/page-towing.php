<?php
/*
Template Name: Буксировка и техпомощь
*/
?>
...
<main>
  <section class="towing background-car">
    <div class="content">
      ...
      <h2 class="towing__title">
        <span class="towing__header"><?php the_field('towing_head') ?></span><br>
      ...
      <ul class="services__items">
        ...
        $my_posts = get_posts( array(
          ...
          foreach( $my_posts as $post ) {
            ...
            ?>
        <li class="services__item"><?php the_title() ?></li>
        <?php
          }
          wp_reset_postdata(); // сброс
          ?>
      </ul>
      <a class="button-typical services__button" role="button" href="/services/">
  ...
  <section class="roadside">
    <div class="content">
      ...
      <img class="roadside__img roadside__img--position-right" src="<?php the_field('kartinka_1') ?>" alt="Help road"
      ...
      <div class="clear"></div>
      <img class="roadside__img roadside__img--position-left" src="<?php the_field('kartinka_2') ?>" alt="Help oil"
        title="Помощь на дороге">
